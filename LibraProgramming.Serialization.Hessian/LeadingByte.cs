...
{
    internal sealed class LeadingByte
    {
        public byte Data
        {
            get;
        ...
        public bool IsNull => Marker.Null == Data;

        public bool IsTrue => Marker.True == Data;

        public bool IsFalse => Marker.False == Data;

        public bool IsTinyInt32 => 0x80 <= Data && 0xBF >= Data;

        public bool IsShortInt32 => 0xC0 <= Data && 0xCF >= Data;

        public bool IsCompactInt32 => 0xD0 <= Data && Data <= 0xD7;
